...
Then, by analyzing a connection to Node2Vec, we demonstrate how the geometry stems from a spectral bias that — in contrast to prevailing theories — indeed arises naturally despite the lack of various pressures. This analysis also points out to practitioners a visible headroom to make Transformer memory more strongly geometric. We hope the geometric view of parametric memory encourages revisiting the default intuitions that guide researchers in areas like knowledge acquisition, capacity, discovery, and unlearning.`,
  ...
  {
    id: 't2s2',
    title: 'Reconstructing Sepsis Trajectories from Clinical Case Reports using LLMs',
    ...
    links: [
      { label: 'ArXiv', url: 'https://arxiv.org/abs/2504.12326' },
    ],
    abstract: `Clinical case reports contain detailed temporal narratives that can support patient trajectory modeling when converted into structured timelines. T2S2 reconstructs sepsis trajectories from clinical case reports using LLM-assisted extraction, producing temporally organized patient events for downstream clinical AI tasks.`,
  },
  {
    ...
    authors: 'S. Noroozizadeh',
    links: [
      { label: 'ArXiv', url: 'https://arxiv.org/abs/2605.15168' },
    ],
    abstract: `This work studies clinical timeline reconstruction through retrieval-augmented multimodal alignment, combining narrative text signals with tabular temporal structure to recover what happened and when it happened in longitudinal patient records.`,
  },
  {
    id: 'surv-hte',
