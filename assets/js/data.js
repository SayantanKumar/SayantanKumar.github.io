...
const TIMELINE = [
  {
    ...
    role: 'B.A.Sc. Engineering Physics',
    period: '2014 – 2018',
    location: 'Vancouver, BC',
    logo: 'images/ubc-logo.svg',
    type: 'academic',
    details: `Graduated with high honours with the Bachelor of Applied Science in Engineering Physics (with Electrical Engineering and Computer Science specialization) in 2018. At UBC I researched on Automated Pathology and worked on GPU Accelerated Photoacoustic Tomography at the Robotics and Control Laboratory under the supervision of Prof. Tim Salcudean. Dean's Honour List (4×). Chancellor's Scholar.`,
  },
  {
    id: 'microsoft',
    label: 'Microsoft',
  ...
  },
  {
    ...
    logo: 'images/cmu-logo.svg',
    type: 'academic',
    details: `Master's of Science in Biomedical Engineering (2020). Thesis in Neuromodulation: Characterization of Transcranial Focused Ultrasound Field to Reduce Ultrasonic Standing Waves. Multiple neural engineering research projects ranging from neural device development and neural signal processing and computation. CMU Presidential Fellowship (2018–2019).`,
  },
  {
    id: 'cmu-ml',
    label: 'CMU MLD',
    ...
    logo: 'images/cmu-logo.svg',
    type: 'academic',
    details: `Master's of Science in Machine Learning from the Machine Learning Department of the School of Computer Science at Carnegie Mellon University, 2022. Center for Machine Learning and Health (CMLH) Digital Health Innovation Fellowship (2022–2023).`,
  },
  {
    id: 'cmu-phd',
    label: 'CMU PhD',
    full_name: 'Carnegie Mellon University',
    role: 'Ph.D. Machine Learning + Public Policy',
    period: '2021 – Present',
    location: 'Pittsburgh, PA',
    logo: 'images/cmu-logo.svg',
    type: 'academic',
    details: `Joint Machine Learning and Public Policy Management Ph.D. student at the Machine Learning Department of the School of Computer Science and Heinz College of Information Systems and Public Policy at Carnegie Mellon University. Advised by Prof. George Chen (Heinz and MLD) and Prof. Jeremy Weiss (National Library of Medicine at NIH). MLD Mentor: Prof. Zachary Lipton. NSERC CGS-D/PGS-D Fellowship (2023–2026). TCS Presidential Fellowship (2024–2025). Suresh Konda Memorial Ph.D. First Research Paper Award (2023).`,
  },
  {
    id: 'sanofi',
    label: 'Sanofi',
